angular.module "ngtuvok"
  .controller "AdminSinglePostCtrl", ($scope, $firebase, $routeParams, BlogService) ->
    ...
    $scope.singlepost = BlogService.getPostById($routeParams.id)
    $scope.savePost = ->
      BlogService.savePost($scope.singlepost)
      return
